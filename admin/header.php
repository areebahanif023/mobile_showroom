...
<head>
    ...
    <title>Online Mobile Showroom - Dashboard</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="d-flex">
        <nav class="sidebar bg-dark">
            <ul class="list-unstyled">
                ...
                <li><a href="company.php" class="sidebar-link"><i class="fas fa-building"></i> Company</a></li>
                <li><a href="category.php" class="sidebar-link"><i class="fas fa-list"></i> Category</a></li>
                <li><a href="mobile.php" class="sidebar-link"><i class="fa-solid fa-mobile-screen-button"></i> Mobile</a></li>
                <li><a href="employee.php" class="sidebar-link"><i class="fas fa-user-friends"></i> Employee</a></li>
                ...
                <li><a href="search_history.php" class="sidebar-link"><i class="fas fa-search"></i> Search History</a></li>
                <li><a href="report.php" class="sidebar-link"><i class="fas fa-calendar-alt"></i> Report</a></li>
