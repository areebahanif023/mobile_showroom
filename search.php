...
?>
    ...
    <main class="products-section">
        <div class="container">
			...
			$sql="select mobile.*, cat_name, company_name from mobile INNER JOIN company on company.id=mobile.company_id INNER JOIN category on category.id=mobile.cat_id where cat_name LIKE '%$keyword%' OR company_name LIKE '%$keyword%' OR pro_name LIKE '%$keyword%' OR price LIKE '%$keyword%' OR mobile.description LIKE '%$keyword%'";
			$result=mysqli_query($con,$sql);
